macro(SetupPhotonFirmware PROJECT)
    ...
    ExternalProject_Add(
        ...
        BUILD_COMMAND make make_deps -j1 PLATFORM=${PARTICLE_PLATFORM}
        INSTALL_COMMAND ""
    )
    ...
    # Build full firmware
    add_custom_target(${PROJECT}-firmware ALL
    ...
    add_custom_target(${PROJECT}-firmware-upload
        DEPENDS ${PROJECT}-firmware
        DEPENDS particle-firmware-deps
        WORKING_DIRECTORY "${FIRMWARE_DIR}/main"
